 ...
 *      replay button, progress bars, etc.) that are fine for human
 ...
 *
 * Chrome elements hidden by default (explicit chrome class names + `.no-record`
...
// CSS to hide "chrome" elements during recording. Keep this list scoped to
// controls; generic content names like `.title` or `.footer` hide real slides.
