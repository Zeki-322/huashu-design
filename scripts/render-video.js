 ...
 *      replay button, explicit chrome markers, etc.) that are fine for human
 ...
 *
 * Chrome elements hidden by default (`.no-record`, explicit chrome markers,
 * and obvious fixed control bars). Pass --keep-chrome to disable this and see raw HTML.
 *
...
// CSS to hide explicit "chrome" elements during recording.
